...
class RetrievalPipeline:
    ...
    def retrieve(self, user_query: str, num_snippets: int, threshold: float) -> List[str]:
        ...
        Args:
            ...
            num_snippets (int): The number of snippets to retrieve.
        ...
        selected_snippets = self.select_documents(retrieved_docs, num_snippets, threshold)
        
        # TODO: Whatever remaining steps are needed
        
        assert len(selected_snippets) <= num_snippets   # Ensure that the number of snippets is less than or equal to the number of snippets requested
